...
ALL="exit maximum power factorial toupper records hello_world_nolib hello_world_lib printf_example records_shared alloc alloc_shared conversion_program"
